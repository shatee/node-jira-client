...
var JiraApi = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(JiraApi, [{
    ...
    key: "updateFilter",
    value: function updateFilter(filterId, filter) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/filter/".concat(filterId)
      }), {
        method: 'PUT',
    ...
    key: "deleteFilter",
    value: function deleteFilter(filterId) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/filter/".concat(filterId)
      }), {
        method: 'DELETE'
    ...
    key: "addSharePermission",
    value: function addSharePermission(filterId, type) {
      var option = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: "/filter/".concat(filterId, "/permission")
      }), {
        method: 'POST',
        body: _objectSpread({
          type: type
